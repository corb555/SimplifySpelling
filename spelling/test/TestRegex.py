...
from spelling import GeoUtil
from spelling.test.TestRunner import TestRunner
...
class TestRegex(TestRunner):
    ...
    cases2 = [
        ('county of westphalia ', 'westfalen cathedral'),  # kathedrale, westfalen, kommune
        ]
