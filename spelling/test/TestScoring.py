...
from spelling import GeoUtil, Spelling, Loc, MatchScore
from spelling.MatchScore import Score as SC
...
class TestScoring(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        TestScoring.geodata = Spelling.Geodata(directory_name=directory, display_progress=None,
